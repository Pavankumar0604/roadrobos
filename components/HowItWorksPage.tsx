...
const steps = [
  ...
  },
  {
    ...
    title: 'Return & Refund',
    description: 'Return the bike to the designated drop-off point at the end of your trip. We’ll conduct a quick inspection of the bike, and your security deposit will be promptly refunded to your account within 5-7 business days.'
  }
];
