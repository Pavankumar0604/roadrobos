...
export const offersData: Offer[] = [
  ...
  },
  {
    ...
    minBooking: '₹500',
    imagePlaceholder: 'https://picsum.photos/seed/offer_welcome10/600/400',
    descriptionBullets: ['Valid for new users.', 'Get 10% off on your first booking.', 'No maximum discount limit.'],
    status: 'Active',
    usageLimitPerUser: 1,
    totalUses: 0,
  },
...
export const transactionsData: Transaction[] = [
  { id: 'txn_123abc', bookingId: "RRS-1672531200000", customerName: 'Aarav Sharma', amount: 1800, status: 'Paid', date: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString() },
  { id: 'txn_456def', bookingId: "RRS-1672617600000", customerName: 'Priya Patel', amount: 550, status: 'Paid', date: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString() },
];

export const initialSiteContent: SiteContent = {
  home: {
    heroTitleTemplate: 'Rent Bikes in [city] — From ₹35/hr',
